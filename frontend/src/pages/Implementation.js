...
const Implementation = () => {
    return(
        <section className="flex flex-col justify-center items-start p-20 text-lg">
            ...
            <aside>Unleashing the Power of Histogram of Gradients, Bag of Words, kNN Nearest Neighbors,
            ...
            <p className="">In my computer vision course at university, my professor gave our entire class full
            ...
            <p>The Image Classification Model is broken down into four steps:</p>
            <ul>
            ...
            <p>The methology behind our implementation is Bag of Words (BoW). It utilizes a feature extractor to build
            ...
            <p>Each step will be gone in more depth.</p>

            <h2><b>1. Histogram of Gradient (HoG) Feature Extraction</b></h2>
            <p>Histogram of Oriented Gradient (HoG) is a feature descriptor which can capture edge information and object 
            ...
            <h3><b>Compute the Gradients</b></h3>
            <p>The gradients in both the <InlineMath math="I_x" /> and <InlineMath math="I_y" /> directions are computed using central differences 
            ...
            <h3><b>Computing Magnitude and Direction</b></h3>
            <p>
            ...
            <h3><b>Cell Orientation Histograms</b></h3>
            <p>Now, we finally construct our histogram. After these calculations, we divide our image into 8x8 pixel cells. 
            ...
            <h3><b>Normalizing Our Histogram</b></h3>
            <p>When do mass computations like we have before, we will get a lot of interference due to natural occurences
            ...
            <p>Now, we are done in developing our feature extractor! We could have used a library to simplify the process two fold, however
            ...
            <h2><b>2. Dictionary Learning & Classifying</b></h2>
            <p>Now we delve into the core of our system. Using the Histogram of Oriented Gradients (HoG) feature extractor, 
            ...
            <h3><b>Clustering Features Together</b></h3>
            <p>We use the terms "clusters" and "words" interchangeably because they are conceptually equivalent in this 
            ...
            <h3><b>Building the Bag-of-Words Vector (Constructing Our Dictionary)</b></h3>
            <p>
            ...
            <h3><b>Training and Classifying the Data Using Support Vector Machine (SVM)</b></h3>
            <p>We choose an SVM classifier to create a statistical model for classifying images as cats or dogs. 
            ...
            <p>Where <InlineMath math="y_i" /> is the corresponding label, <InlineMath math="b" /> being the bias, <InlineMath math="x_i" /> is the feature vector, and <InlineMath math="i" /> is current 
